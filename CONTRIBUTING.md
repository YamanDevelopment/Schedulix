...
Do you have any struggles with the issue you are working on? Feel free to **tag [me](https://github.com/RealStr1ke)** in it _and/or_ open a draft pull request.
...
Fork this repository by clicking on the fork button on the top of [this](https://github.com/RealStr1ke/Schedulix) page.
...
#### Setup the project in your local by following the steps listed in the [README.md](https://github.com/RealStr1ke/Schedulix/blob/main/README.md) file
